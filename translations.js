...
const translations = {
    en: {
        ...
        'about.section2.title': 'Understanding the Composite Score',
        'about.section2.text1': 'The Composite Sentiment Score is the heart of our dashboard. It\'s a number between -100 and +100 that represents the overall market sentiment:',
        ...
        'about.section3.text1': 'Our Composite Score combines five key "drivers" of market sentiment. Each driver is analyzed independently and then weighted to create the final score:',
        ...
        'about.section4.item1': '<strong>Check the Composite Score</strong> - Start with the main sentiment score (left side of the dashboard) to get an instant read on market mood.',
        ...
        'news.filter.all': 'All',
        'news.filter.positive': 'Positive',
        'news.filter.negative': 'Negative',
        'news.filter.neutral': 'Neutral',
        'news.stat.total': 'Total Articles',
        'news.stat.positive': 'Positive',
        'news.stat.neutral': 'Neutral',
        'news.stat.negative': 'Negative',
        ...
        // Dashboard
        'dashboard.score.label': 'Composite Sentiment Score',
        ...
        'dashboard.chart.timeframe.8h': '8 hrs',
        'dashboard.chart.timeframe.1d': '1 day',
    ...
    es: {
        ...
        'news.filter.positive': 'Positivas',
        'news.filter.negative': 'Negativas',
        'news.filter.neutral': 'Neutrales',
        'news.stat.total': 'Total de Artículos',
        'news.stat.positive': 'Positivas',
        'news.stat.neutral': 'Neutrales',
        'news.stat.negative': 'Negativas',
        ...
        'news.sentiment.positive': 'POSITIVA',
        'news.sentiment.negative': 'NEGATIVA',
        'news.sentiment.neutral': 'NEUTRAL',
        ...
        'dashboard.chart.timeframe.4h': '4 hrs',
        'dashboard.chart.timeframe.8h': '8 hrs',
        'dashboard.chart.timeframe.1d': '1 día',
    ...
    fr: {
        ...
        'about.section2.title': 'Comprendre le Score Composite',
        'about.section2.text1': 'Le Score de Sentiment Composite est le cœur de notre tableau de bord. C\'est un nombre entre -100 et +100 qui représente le sentiment global du marché:',
        ...
        'about.section3.text1': 'Notre Score Composite combine cinq "moteurs" clés du sentiment du marché. Chaque moteur est analysé indépendamment puis pondéré pour créer le score final:',
        ...
        'about.section4.item1': '<strong>Vérifiez le Score Composite</strong> - Commencez par le score de sentiment principal (côté gauche du tableau de bord) pour obtenir une lecture instantanée de l\'humeur du marché.',
        ...
        'news.filter.positive': 'Positives',
        'news.filter.negative': 'Négatives',
        'news.filter.neutral': 'Neutres',
        'news.stat.total': 'Total d\'Articles',
        'news.stat.positive': 'Positives',
        'news.stat.neutral': 'Neutres',
        'news.stat.negative': 'Négatives',
        ...
        'news.sentiment.positive': 'POSITIVE',
        'news.sentiment.negative': 'NÉGATIVE',
        'news.sentiment.neutral': 'NEUTRE',

        // Dashboard
        'dashboard.score.label': 'Score de Sentiment Composite',
        ...
        'dashboard.chart.timeframe.8h': '8 h',
        'dashboard.chart.timeframe.1d': '1 jour',
    ...
    de: {
        ...
        'about.section2.title': 'Den Composite Score Verstehen',
        'about.section2.text1': 'Der Composite Stimmungs-Score ist das Herzstück unseres Dashboards. Es ist eine Zahl zwischen -100 und +100, die die allgemeine Marktstimmung darstellt:',
        'about.section2.bullish': 'BULLISH',
        ...
        'about.section3.text1': 'Unser Composite Score kombiniert fünf wichtige "Treiber" der Marktstimmung. Jeder Treiber wird unabhängig analysiert und dann gewichtet, um den endgültigen Score zu erstellen:',
        ...
        'about.section4.item1': '<strong>Überprüfen Sie den Composite Score</strong> - Beginnen Sie mit dem Hauptstimmungs-Score (linke Seite des Dashboards), um eine sofortige Einschätzung der Marktstimmung zu erhalten.',
        ...
        'news.filter.positive': 'Positive',
        'news.filter.negative': 'Negative',
        'news.filter.neutral': 'Neutrale',
        'news.stat.total': 'Gesamtartikel',
        'news.stat.positive': 'Positive',
        'news.stat.neutral': 'Neutrale',
        'news.stat.negative': 'Negative',
        ...
        'news.sentiment.positive': 'POSITIV',
        'news.sentiment.negative': 'NEGATIV',
        'news.sentiment.neutral': 'NEUTRAL',

        // Dashboard
        'dashboard.score.label': 'Composite Stimmungs-Score',
        ...
        'dashboard.chart.timeframe.8h': '8 Std',
        'dashboard.chart.timeframe.1d': '1 Tag',
    ...
    zh: {
        ...
        'news.title': '最新新闻',
        'news.filter.all': '全部',
        'news.filter.positive': '积极',
        'news.filter.negative': '消极',
        'news.filter.neutral': '中性',
        'news.stat.total': '文章总数',
        'news.stat.positive': '积极',
        'news.stat.neutral': '中性',
        'news.stat.negative': '消极',
        ...
        'dashboard.chart.timeframe.8h': '8小时',
        'dashboard.chart.timeframe.1d': '1天',
    ...
    ja: {
        ...
        'news.filter.all': 'すべて',
        'news.filter.positive': 'ポジティブ',
        'news.filter.negative': 'ネガティブ',
        'news.filter.neutral': '中立',
        'news.stat.total': '記事総数',
        'news.stat.positive': 'ポジティブ',
        'news.stat.neutral': '中立',
        'news.stat.negative': 'ネガティブ',
        ...
        'news.sentiment.positive': 'ポジティブ',
        'news.sentiment.negative': 'ネガティブ',
        ...
        'dashboard.chart.timeframe.8h': '8時間',
        'dashboard.chart.timeframe.1d': '1日',
